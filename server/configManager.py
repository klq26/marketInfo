...
class configManager:
    ...
    def __init__(self):
        ...
        # 反射机制信息注册（方便并发接口解耦）
        self.moneyinfo = [
            {'name' : '沪深两市成交额（亿）', 'symbol' : 'hslscje', 'url' : 'https://hq.sinajs.cn/?list=sh000002,sz399107'},
            {'name' : '融资融券余额（亿）', 'symbol' : 'rzrqye', 'url' : 'http://api.dataide.eastmoney.com/data/get_rzrq_lshj?orderby=dim_date&order=desc&pageindex=1&pagesize=240'},
        ...
        self.zdpinfo = [
            ...
            {'name' : '指数涨跌平', 'symbol' : 'zszdp', 'url' : 'https://hq.sinajs.cn/list=sh000002_zdp,sz399107_zdp,sh000003_zdp,sz399108_zdp,sz399102_zdp,sh000016_zdp,sh000300_zdp,sz399905_zdp,sh000852_zdp,sh000842_zdp'},
        ]
